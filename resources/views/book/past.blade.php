        ...
        <div class="side col-lg-7">
            <div>
                ...
                <div class="d-flex float-right">
                    <p class=" m-2">
                        <a href="{{ url('/edit')}}" class="btn btn-success">編集</a>
                    </p>
                    <p class=" m-2">
                        <a href="{{ url('/delete')}}" class="btn btn-success" onClick="return confirm('削除しますか？')">削除</a>
                    </p>
                    <p class=" m-2">
